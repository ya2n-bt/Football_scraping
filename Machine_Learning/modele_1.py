...
for name, config in models_config.items():
    ...
    if cv_r2_score > best_overall_cv_score:
        ...
        pipeline_modele_gagnant = grid_search.best_estimator_
...
y_pred_final = pipeline_modele_gagnant.predict(X_test)
...
joblib.dump(pipeline_modele_gagnant, 'modele_final.pkl')
print(f"Modèle sauvegardé sous 'modele_final.pkl'")

# ---  PRÉDICTIONS SUR LE DF COMPLET ---
df_complet = df.copy()

df_complet['valeur_estimee'] = pipeline_modele_gagnant.predict(df_complet[cols_utiles])
